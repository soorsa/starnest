...
const PageNotFound: React.FC = () => {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center">
      <div className="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-xs h-auto rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-sm md:max-w-md mx-auto">
        <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
          <span className="relative mx-auto -mt-16 mb-8 bg-primary border-2 border-secondary h-30 w-30 flex flex-col justify-center items-center rounded-full">
            <svg
          ...
          <div className="grid grid-cols-2 gap-4 text-sm w-full">
            ...
            <Link
              to={"/"}
              className="flex items-center gap-2 bg-sky-500 text-white hover:bg-sky-700 p-2 rounded-lg w-full justify-center"
            >
              <Home size={20} />
