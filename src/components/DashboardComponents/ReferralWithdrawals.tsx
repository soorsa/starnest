...
const RefWithdrawalHistory: React.FC<Props> = ({
  data,
  isLoading,
  isError,
}) => {
            ...
            >
              <div className="flex flex-1 items-center divide-gray-300 divide-x ">
                ...
                <div className="px-2 text-left flex-1">
                  <div className="font-starnest-mid">Withdrawal request </div>
                  <div className="">for referral earnings</div>
                </div>
              </div>
...
export default RefWithdrawalHistory;
