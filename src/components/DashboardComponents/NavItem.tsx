    ...
    <div className="w-full">
      ...
      {path ? (
        ...
        <button
          ...
          className="flex items-center justify-between w-full px-3 py-[7px] text-black rounded-md hover:bg-white"
        >
          <div className="flex items-center space-x-2">
            {icon}
            <span>{label}</span>
      ...
      {/* Nested Items */}
      {isOpen && children && (
        <div className="px-0 mt-2 ml-6 space-y-2 border-l-1 border-gray-500">
